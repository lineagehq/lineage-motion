...
export const verificationSuites = {
  ...
  'fast-unit': {
    ...
    'packages/domain/src/sequence.test.ts',
    'packages/css-compiler/src/sequence-viewport.test.ts',
    'packages/domain/src/document-authoring.test.ts',
  ...
  'service-integration': vitest([
    ...
    'packages/local-service/src/sequence-integrity.test.ts',
  ...
  recovery: vitest([
    'packages/local-service/src/sequence-recovery.test.ts',
